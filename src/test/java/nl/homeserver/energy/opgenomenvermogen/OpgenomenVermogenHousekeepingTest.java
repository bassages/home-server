...
class OpgenomenVermogenHousekeepingTest {
    ...
    void whenCleanupThenKeptAndDeletedOpgenomensAreLogged(final ArgumentCaptor<LoggingEvent> loggerEventCaptor) {
        ...
        assertThat(loggerEventCaptor.getAllValues())
            .haveExactly(1, new ContainsMessageAtLevel("OpgenomenVermogen(id=2, datumtijd=2016-01-01T00:00:01, datum=2016-01-01, activePowerTotalInWatts=0, activePowerL1InWatts=0, activePowerL2InWatts=0, activePowerL3InWatts=0, voltageL1=null, voltageL2=null, voltageL3=null, tariefIndicator=NORMAAL)", DEBUG))
            .haveExactly(1, new ContainsMessageAtLevel("OpgenomenVermogen(id=1, datumtijd=2016-01-01T00:00, datum=2016-01-01, activePowerTotalInWatts=0, activePowerL1InWatts=0, activePowerL2InWatts=0, activePowerL3InWatts=0, voltageL1=null, voltageL2=null, voltageL3=null, tariefIndicator=NORMAAL)", DEBUG));
    }
}
