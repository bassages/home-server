...
public class OpgenomenVermogenServiceTest {
    ...
    public void shouldKeepLatestRecordInMinuteWhenWattIsTheSame() {
        ...
        OpgenomenVermogen opgenomenVermogen1 = OpgenomenVermogenBuilder.aOpgenomenVermogen().withDatumTijd(date.atTime(0, 0, 0)).withWatt(1).build();
        OpgenomenVermogen opgenomenVermogen2 = OpgenomenVermogenBuilder.aOpgenomenVermogen().withDatumTijd(date.atTime(0, 0, 10)).withWatt(1).build();
        OpgenomenVermogen opgenomenVermogen3 = OpgenomenVermogenBuilder.aOpgenomenVermogen().withDatumTijd(date.atTime(0, 0, 20)).withWatt(1).build();
    ...
    public void shouldKeepHighestWatt() {
        ...
        OpgenomenVermogen opgenomenVermogen1 = OpgenomenVermogenBuilder.aOpgenomenVermogen().withDatumTijd(date.atTime(0, 0, 0)).withWatt(3).build();
        OpgenomenVermogen opgenomenVermogen2 = OpgenomenVermogenBuilder.aOpgenomenVermogen().withDatumTijd(date.atTime(0, 0, 10)).withWatt(2).build();
        OpgenomenVermogen opgenomenVermogen3 = OpgenomenVermogenBuilder.aOpgenomenVermogen().withDatumTijd(date.atTime(0, 0, 20)).withWatt(1).build();
    ...
    public void shouldCleanUpPerMinuteAndDeletePerHour() {
        ...
        OpgenomenVermogen opgenomenVermogen1 = OpgenomenVermogenBuilder.aOpgenomenVermogen().withDatumTijd(date.atTime(12, 0, 0)).build();
        OpgenomenVermogen opgenomenVermogen2 = OpgenomenVermogenBuilder.aOpgenomenVermogen().withDatumTijd(date.atTime(12, 0, 10)).build();

        OpgenomenVermogen opgenomenVermogen3 = OpgenomenVermogenBuilder.aOpgenomenVermogen().withDatumTijd(date.atTime(12, 1, 0)).build();
        OpgenomenVermogen opgenomenVermogen4 = OpgenomenVermogenBuilder.aOpgenomenVermogen().withDatumTijd(date.atTime(12, 1, 10)).build();

        OpgenomenVermogen opgenomenVermogen5 = OpgenomenVermogenBuilder.aOpgenomenVermogen().withDatumTijd(date.atTime(13, 1, 0)).build();
        OpgenomenVermogen opgenomenVermogen6 = OpgenomenVermogenBuilder.aOpgenomenVermogen().withDatumTijd(date.atTime(13, 1, 10)).build();
