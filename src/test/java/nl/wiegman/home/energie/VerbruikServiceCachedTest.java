...
public class VerbruikServiceCachedTest {
    ...
    @Test
    public void givenNoEnergiecontractsWhenGetStroomVerbruikNormaalThenNoKosten() throws ParseException {
        long periodeVan = 10;
        ...
        Verbruik verbruik = verbruikServiceCached.getPotentiallyCachedStroomVerbruikInPeriode(periodeVan, periodeTotEnMet, StroomTariefIndicator.NORMAAL);
    ...
    @Test
    public void givenNoEnergiecontractsWhenGetStroomVerbruikDalThenNoKosten() throws ParseException {
        long periodeVan = 50;
        ...
        Verbruik verbruik = verbruikServiceCached.getPotentiallyCachedStroomVerbruikInPeriode(periodeVan, periodeTotEnMet, StroomTariefIndicator.DAL);
    ...
    public void givenNoEnergiecontractsWhenGetGasVerbruikThenNoKosten() throws ParseException {
        ...
        Verbruik verbruik = verbruikServiceCached.getPotentiallyCachedGasVerbruikInPeriode(periodeVan, periodeTotEnMet);
    ...
    public void givenMultipleEnergiecontractsWhenGetStroomverbruikNormaalThenVerbruikIsCalculated() throws ParseException {
        ...
        Verbruik verbruik = verbruikServiceCached.getPotentiallyCachedStroomVerbruikInPeriode(10, 20, StroomTariefIndicator.NORMAAL);
    ...
    public void givenMultipleEnergiecontractsWhenGetStroomverbruikDalThenVerbruikIsCalculated() throws ParseException {
        ...
        Verbruik verbruik = verbruikServiceCached.getPotentiallyCachedStroomVerbruikInPeriode(10, 20, StroomTariefIndicator.DAL);
    ...
    public void givenMultipleEnergiecontractsWhenGetGasverbruikThenVerbruikIsCalculated() throws ParseException {
        ...
        Verbruik verbruik = verbruikServiceCached.getPotentiallyCachedGasVerbruikInPeriode(10, 20);
