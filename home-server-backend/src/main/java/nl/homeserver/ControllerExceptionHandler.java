...
public class ControllerExceptionHandler {
    ...
    public ResponseEntity<ErrorResponse> createResponse(DataIntegrityViolationException dataIntegrityViolationException) {
    ...
    public ResponseEntity<ErrorResponse> createResponse(ResourceNotFoundException resourceNotFoundException) {
